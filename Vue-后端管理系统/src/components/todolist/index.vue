<template>
  <section class="todoapp">
    <!-- header -->
    <header class="header">
      <input class="new-todo" autofocus autocomplete="off" placeholder="添加项目" @keyup.enter="addTodo">
    </header>
    <!-- main section -->
    ...
    <footer class="footer" v-show="todos.length">
      <span class="todo-count">
        <strong>{{ remaining }}</strong> 个项目未完成
      </span>
      <ul class="filters">
...
const defalutList = [
  { text: '开会', done: false },
  { text: '开启项目', done: false },
  { text: '分配任务', done: false },
  { text: '项目进度会议', done: false },
  { text: '前后端UI交互', done: false },
  { text: '提交测试', done: false },
  { text: '修改bug', done: false }
]
export default {
  components: { Todo },
  data () {
